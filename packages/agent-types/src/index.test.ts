...
test("@gsd/agent-types seam: built dist entrypoint exists and matches package.json main", () => {
...
test("@gsd/agent-types seam: module loads cleanly with no unintended exports", async () => {
