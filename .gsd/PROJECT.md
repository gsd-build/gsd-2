...
- [x] M007: Telemetry, Metrics, and Experiment Fixtures — S01 telemetry schema done, S02 metrics aggregation/reporting done (CLI + reader), S03 fixture harness done (3 concept fixtures + validation + e2e tests)
