...
- [ ] **S01: Upstream merge and build stabilization** `risk:high` `depends:[]`
  > After this: `npm run build` and `npm run build:web-host` succeed with all 398 upstream commits merged. Codebase compiles.
