...
function makeMockDeps(
  ...
  const baseDeps: LoopDeps = {
    ...
    selectAndApplyModel: async (_ctx: unknown, _pi: unknown, _unitType: unknown, _unitId: unknown, _basePath: unknown, _prefs: unknown, _verbose: unknown, _startModel: unknown, _hookModelOverride?: unknown) => ({ routing: null }),
    refreshMemoryBlock: () => "",
